        ...
        for traj_num in args.traj:
            ...
            if config.task == 'uct_3_comp':
                ...
                if args.model == 'analytics' or args.model == 'simulator':
                    ...
                    _configs['get_traindata'] = args.get_traindata
                    _configs['round'] = args.round
                    ...
                    _configs['eff_model'] = args.eff_model
                    _configs['vout_model'] = args.vout_model
                    _configs['debug'] = args.debug
                    _configs['reward_threshold'] = args.reward_threshold
