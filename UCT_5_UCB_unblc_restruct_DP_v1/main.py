...
from Algorithms.Verification import filter_test
...
def main(name='', traj=None, Sim=None, configs=None, uct_tree_list=None, keep_uct_tree=False):
    ...
    for traj in traj_list:
        ...
        if configs["algorithm"] == "UCF" or configs["algorithm"] == "UCT":
            result, anal_results, simu_results, save_tops, filted_save_tops = serial_UCF_test(trajectory=traj,
                                                                                              test_number=configs[
                                                                                                  'test_number'],
            ...
            if Sim is None:  # just for uct with simulator or analytics
                ...
                save_output_tops[traj] = save_tops
                filted_save_output_tops[traj] = filted_save_tops
        elif configs["algorithm"] == "filter":
            result, anal_results, simu_results, save_tops, filted_save_tops = filter_test(trajectory=traj,
                                                                                          test_number=configs[
                                                                                              'test_number'],
                                                                                          result_folder=result_folder,
                                                                                          configs=configs,
